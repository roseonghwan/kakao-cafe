...
class PaymentManager:
    ...
    def selectPaymentWay(self, totalPrice):  # 결제수단을 고르는 함수
    ...
    def cashPay(self, totalPrice):  # 현금결제
        if self.__cash >= totalPrice:
            self.__change = self.__cash - totalPrice  # 거스름돈 계산
